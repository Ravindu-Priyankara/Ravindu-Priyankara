...
$\texttt{\color{lime}{Welcome  I   am  a  backend  developer  with  a  passion  for  building  robust  and }}$
$\texttt{\color{lime}{scalable  systems. With  4  years  of  experiencein  the  field,  I've  worked  on  various }}$
$\texttt{\color{lime}{projects  ranging  fromAPI  development  to  database  optimization.}}$
<br>
<!--about me text  section end-->

<!--Status  text  section start-->
## ✡️ Status

$\texttt{\color{lime}{👩‍💻 I'm currently working on\color{red} :\color{cyan} My freelancing projects}}$
<br>

$\texttt{\color{lime}{🧠  I'm currently learning\color{red}  :\color{cyan}  Algorithms Development to enhance my problem-solving skills }}$  
$\texttt{\color{cyan}{and optimize the efficiency of my code. }}$
<br>

$\texttt{\color{lime}{👯 I'm looking to collaborate on\color{red} :\color{cyan} Opensource Projects to contribute to the communityand }}$ 
$\texttt{\color{cyan}{expand myknowledge software development.}}$

$\texttt{\color{lime}{💬 Ask me about\color{red} : \color{cyan}anything related to backend development, Python, Java, or freelancing }}$ 
$\texttt{\color{cyan}{experiences—I'm always happy to share my insights and help others grow. }}$
<br>

$\texttt{\color{lime}{⚡️ Fun fact \color{red}:\color{cyan}  I'm intrigued by the mysteries of the world, from exploring abandoned places }}$ 
$\texttt{\color{cyan}{to delving into the realm of ghost hunting. There's an undeniable thrill in uncovering the}}$
$\texttt{\color{cyan}{unknown and unraveling the secrets that lie beneath the surface. Whether it's investigating }}$ $\texttt{\color{cyan}{paranormal phenomena or seeking out hidden treasures, I'm always up for an adventure that }}$ 
$\texttt{\color{cyan}{promises to challenge perceptions and ignite the imagination. }}$
<!--Status  text  section end-->

<!--language and tool  icon  section start-->
...
<!--language and tool  icon  section end-->

<!--stat  graph  section start-->
## ✡️ Stats
